...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        ...
        $('#tb_departments').bootstrapTable({
            url: '/FlowerChange/GetList',           //请求后台的URL（*）
            method: 'get',                     //请求方式（*）
            ...
            columns: [{
                ...
                field: 'WorkUsersRealName',

                title: '对应负责人姓名'
            }
            , {
                field: 'ContentMsg',
                title: '更换内容', formatter: function (value, row, index) {
                    return '<a onclick="ShowMsg(\'' + value + '\')"  href="javascript:void(0)">' + value + '</a>';
                }
            }
            , {
                field: 'Photo',
                title: '更换前图片', formatter: function (value, row, index) {

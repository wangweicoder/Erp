    ...
    oTableInit.Init = function () {
        ...
        $('#tb_departments').bootstrapTable({
            ...
            columns: [{
                ...
                field: 'FlowerWatchPhoto',
                title: '花卉照片', formatter: function (value, row, index) {
                    return '<a onclick="ShowPhoto(\'Flower\',' + row.id + ')"  href="javascript:void(0)" ><img style="height:40px;width:40px"  src="' + value + '" /><a/>';
                }
            }
            , {
            ...
            , {
                field: 'FlowerCostPrice',
                title: '花卉成本价(￥)',
            }
              , {
                  field: 'FlowerSalesPrice',
                  title: '花卉销售价(￥)',
              }
 , {
     field: 'XiXin',
  ...
  , {
    ...
    oTableInit.queryParams = function (params) {
        var temp = {   //这里的键的名字和控制器的变量名必须一直，这边改动，控制器也需要改成一样的
            ...
            FlowerWatchName: $("#FlowerWatchName").val(),
        };
        return temp;
    };
    return oTableInit;

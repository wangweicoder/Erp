...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        ...
        $('#tb_departments').bootstrapTable({
            url: '/ChangingFlowerExpenses/GetList',           //请求后台的URL（*）
            method: 'get',                     //请求方式（*）
            ...
            , {
                ...
                title: '成本价',
                    footerFormatter: function (value) {
                        var count = 0;
                        for (var i in value) {
                            if (value[i].CostPrice != '' && value[i].CostPrice != null) {
                                count += parseInt(value[i].CostPrice);
                            }
                        }
                        return count;
                    }
            ...
            , {
                field: 'ReplacementTelephone',
                title: '更换人手机号',
            }
           
            , {
                field: 'ReplacementUnit',
                title: '所属单位',
            }
            , {
                field: 'CreateTime',
                title: '更换时间', formatter: function (value, row, index) {
    ...
    oTableInit.queryParams = function (params) {
        var temp = {   //这里的键的名字和控制器的变量名必须一直，这边改动，控制器也需要改成一样的
            ...
            ReplacementUnit: $("#ReplacementUnit").val(),
        };
        return temp;
    };
    return oTableInit;

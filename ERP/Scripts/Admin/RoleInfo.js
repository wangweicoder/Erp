...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        ...
        $('#tb_departments').bootstrapTable({
            url: '/RoleInfo/GetRoleList',           //请求后台的URL（*）
            method: 'get',                     //请求方式（*）
            ...
            ,  {
                ...
                formatter: function (value, row, index) {     
                   return "<button id=\"btn_edit\" type=\"button\" class=\"btn btn-default btn-xs\" onclick=\"EditMenuList('" + row.ID + "')\" style=\"margin-right:5px\"><span class=\"glyphicon glyphicon-pencil\" aria-hidden=\"true\"></span>设置菜单</button>";
                }
            }
            ]
        });

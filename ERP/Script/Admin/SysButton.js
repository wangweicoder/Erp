...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        ...
        $('#tb_departments').bootstrapTable({
            url: '/SysButton/Sys_Base_Button',           //请求后台的URL（*）
            method: 'get',                     //请求方式（*）
            ...
            , {
                ...
                formatter: function (value, row, index) {
                    var e = '<button id="btn_edit" type="button" class="btn btn-default btn-xs" onclick="parent.layer.open({type: 2,title:\'' + $("#Edit").val() + '\',shadeClose: true,shade: 0.8,area: [\'380px\', \'60%\'],content:\'/SysButton/Edit?Code=' + row.ButtonCode + '\',end: function () {onloadTable();}});" style="margin-right:5px"><span class="glyphicon glyphicon-pencil " aria-hidden="true"></span> ' + $("#Edit").val() + '</button>'
                    return e;
                }
            }]
        });
